            ...
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <div class="page-title-right">
                        ...
                        <a href="{{ route('administrator.tasks.create') }}" class="btn btn-sm btn-dark float-end"><i
                                class="mdi mdi-plus"></i> Add Task</a>
            ...
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <div class="page-title-right">
                        ...
                        <select name="task" class="form-select form-control-sm tsel">
                         <option value="all" @if(request()->get('task') == 'all') selected @endif>All Tasks</option>
                         <option value="my" @if(request()->get('task') == 'my') selected @endif>My Tasks</option>
                        </select>
                                            ...
                                            <tr>
                                                ...
                                                <td class="table-user">
                                                    <a href="{{ route('administrator.tasks.show', $task->id) }}"
                                                        ...
                                                        <br>
                                                        <i class="uil uil-location-point"></i> {{ Str::limit($task->address, 35, $end=' ...')  }}
                                                        <br>
                                                ...
                                                <td>
                                                    <h5>
                                                        <a href="javascript:void(0)"
                                                            class="badge badge-primary-gradient w-100 text-start">{{ $task->type }}</a>
                                                    </h5>

                                                    @isset($task->parent_task_id)
                                                        <h5>
                                                            <a href="javascript:void(0)" class="badge bg-warning text-dark w-100 text-start">Sub
                                                                Task</a>
                                                            <h5>
                                                                <a href="{{ route('administrator.tasks.show', $task->parent_task_id) }}"
                                                                    class="badge bg-dark w-100 text-start">Linked Parent Task</a>
                                                            </h5>
                                                        </h5>
                                                    @endisset
                                                    @php
                                                    ...
                                                    @if ($child_exists)
                                                        <h5><a href="javascript:void(0)"
                                                                class="badge bg-warning text-dark w-100 text-start">Parent Task</a></h5>
                                                        <h5>
                                                            <a href="{{ route('administrator.tasks.show', \App\Models\Task::where('parent_task_id', $task->id)->first()->id) }}"
                                                                class="badge bg-dark w-100 text-start">Linked Child Task</a>
                                                        </h5>
                                                    @endif
                                                ...
                                                @if (isset($task->driver_id))
                                                    @if ($task->status == 'failed')
                                                        <td class="text-danger"><a class="btn btn-sm btn-danger"
                                                                ...
                                                                data-bs-target="#danger-header-modal">Assign Driver</a>
                                                        </td>
                                                    @else
                                                ...
                                                @if (!is_null($task->driver_id))
                                                    <td class="text-center">
                                                        ...
                                                        @if($task->status == 'completed')
                                                            ...
                                                            <a href="{{ route("administrator.merchants.download-order", $task->id) }}" class="btn w-100 mt-1 btn-sm btn-success"> <i
                                                                    class="mdi mdi-check-circle-outline"></i> {{ 'F0000'.$task->id }} </a>
                                                    @endif
                                                                </td>
                                                @else
                                                    <td class="text-center"> <span class="btn btn-sm btn-purple"> <i
                                                                class="mdi mdi-close-box-outline"></i> Unassigned </span>
                                                    </td>
                                                @endif
                                                <td>
