...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <form id="taskForm" method="POST" action="{{ route('administrator.tasks.update', $task->id) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 mb-2 {{ $errors->has('priority') ? 'has-error' : '' }}">
                                    ...
                                    <select class="form-select" id="priority" name="priority">
                                        ...
                                        <option value="urgent"
                                            {{ old('priority', $task->priority) == 'urgent' ? 'selected' : '' }}>Urgent
                                        </option>
                                    </select>
                                    @error('priority')
                                ...
                                <div class="col-sm-4 mb-2 {{ $errors->has('driver') ? 'has-error' : '' }}">
                                    ...
                                    <select class="form-select select2" id="driver" name="driver" data-toggle="select2"
                                        data-placeholder="Select Driver" @if ($task->status == 'completed' || $task->status == 'in-transist' || isset($task->parent_task_id)) disabled @endif>
                                        <option></option>
                                        @foreach ($drivers as $driver)
                                            <option value="{{ $driver->id }}"
                                                {{ old('driver', $task->driver_id) == $driver->id ? 'selected' : '' }}>
                                ...
                                <div class="col-sm-4 mb-2 {{ $errors->has('type') ? 'has-error' : '' }}">
                                    <label class="col-form-label" for="type">Task Type <span
                                            class="text-danger">*</span></label>
                                    <select class="form-select" id="type" name="type" onchange="getServices()">
                                        <option value="">Select Type</option>
                                        <option value="Towing"
                                            {{ old('type', $task->type) == 'Towing' ? 'selected' : '' }}>Towing
                                        </option>
                                        <option value="Battery/Tyre"
                                            {{ old('type', $task->type) == 'Battery/Tyre' ? 'selected' : '' }}>Battery/Tyre
                                        </option>
                                        <option value="Towing & Battery/Tyre"
                                            {{ old('type', $task->type) == 'Towing & Battery/Tyre' ? 'selected' : '' }}>
                                ...
                                <div class="col-sm-4 mb-2 btsize @if (is_null(old('battery_tyre_size', $task->battery_tyre_size))) hidden @endif">
                                    <label class="col-form-label" for="type">Battery/Tyre Size </label>
                                    <input type="text" class="form-control"
                                        value="{{ old('battery_tyre_size', $task->battery_tyre_size) }}"
                                ...
                                <div class="col-sm-4 mb-2 {{ $errors->has('merchant') ? 'has-error' : '' }}">
                                    ...
                                    <select class="form-select select2" id="merchant" name="merchant" data-toggle="select2"
                                        data-placeholder="Select Workshop" onchange="getServices()">
                                        <option></option>
                                        @foreach ($merchants as $merchant)
                                            <option value="{{ $merchant->id }}"
                                                {{ old('merchant', $task->merchant_id) == $merchant->id ? 'selected' : '' }}>
                                    ...
                                    <select class="form-select select2" data-toggle="select2"
                                        ...
                                        @foreach ($services as $service)
                                            <option value="{{ $service->id }}"
                                                {{ old('service', $task->service_id) == $service->id ? 'selected' : '' }}>
                                                {{ $service->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('service')
                                ...
                                <div class="col-sm-4 mb-2">
                                    ...
                                    <input type="number" class="form-control @error('towing_fee') is-invalid @enderror"
                                        ...
                                        step="any" value="{{ old('towing_fee', $task->towing_fee) }}">
                                    @error('towing_fee')
                                ...
                                <div class="col-sm-12 mb-2">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ old('ticket_no', $task->ticket_no) }}" name="ticket_no"
                                ...
                                {{-- <div class="col-sm-4 mb-2">
                                    ...
                                    <input type="number" class="form-control @error('due_amount') is-invalid @enderror"
                                        ...
                                        step="any" value="{{ old('due_amount', $task->due_amount) }}">
                                    @error('due_amount')
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 mb-2">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror"
                                        ...
                                        value="{{ old('email', $task->email) }}" autofocus>
                                    @error('email')
                                ...
                                <div class="col-sm-8 mb-2">
                                    ...
                                    <input id="address" type="text"
                                        ...
                                        value="{{ old('address', $task->address) }}" autocomplete="off"
                                ...
                                {{-- <div class="col-sm-4 mb-2">
                                    ...
                                    <input type="datetime-local" step="any"
                                        ...
                                        name="due_time" value="{{ old('due_time', $task->due_time) }}">
                                    @error('due_time')
                                ...
                                <div class="col-sm-4 mb-2">
                                    <label class="col-form-label" for="vehicle_type">Vehicle Model
                                        ...
                                        class="form-control @error('vehicle_type') is-invalid @enderror" placeholder="Enter vehicle model" value="{{ old('vehicle_type', $task->vehicle_type) }}">
                                    @error('vehicle_type')
                                ...
                                <div class="col-sm-4 mb-2">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('registration_number', $task->registration_number) }}">
                    ...
                    <div class="card descard {{$task->type == 'Battery/Tyre' ? 'hidden' : ''}}">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12 mb-2">
                                ...
                                <div
                                    ...
                                    <input type="text" class="form-control" id="destination_contact_name"
                                        ...
                                        value="{{ old('destination_contact_name', $task->destination_contact_name) }}">
                                ...
                                <div class="col-sm-6 mb-2 {{ $errors->has('destination_phone') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" id="destination-phone"
                                        ...
                                        value="{{ old('destination_phone', $task->destination_phone) }}">
                                    @error('destination_phone')
                                        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                    <input id="destination-dialcode" name="destination_dialcode" type="hidden"
                                        value="{{ isset($admin) ? $task->destination_dialcode : '' }}">
                                ...
                                <div
                                    ...
                                    <input type="email" class="form-control" id="destination_contact_email"
                                        ...
                                        value="{{ old('destination_contact_email', $task->destination_contact_email) }}">
                                ...
                                <div
                                    ...
                                    <input type="text" class="form-control" id="destination_building_floor_room"
                                        ...
                                        value="{{ old('destination_building_floor_room', $task->destination_building_floor_room) }}">
                                ...
                                <div class="col-sm-12 mb-2 {{ $errors->has('destination_notes') ? 'has-error' : '' }}">
                                    ...
                                    <textarea class="form-control" id="destination_notes" name="destination_notes" placeholder="Instruction or notes"
                                        rows="3">{{ old('destination_notes', $task->destination_notes) }}</textarea>
                            ...
                            <div class="col-sm-12 mb-2">
                                ...
                                <div class="input-group">
                                    <textarea class="form-control" id="remarks" name="remarks" placeholder="Write Remarks here"
                                        rows="4">{{ old('remarks', $task->remarks) }}</textarea>
                                    </textarea>
                                </div>
                                @error('remarks')
                                    ...
                                    <div class="mt-2">
                                        <div class="form-check form-check-inline">
                                            <input type="checkbox" class="form-check-input" id="photos"
                                                ...
                                                {{ $task->requirements && in_array('photos', old('requirements', $task->requirements)) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="checkbox" class="form-check-input" id="signature"
                                                ...
                                                {{ $task->requirements && in_array('signature', old('requirements', $task->requirements)) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="checkbox" class="form-check-input" id="notes"
                                                ...
                                                {{ $task->requirements && in_array('notes', old('requirements', $task->requirements)) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="checkbox" class="form-check-input" id="cash-on-delivery"
                                                ...
                                                {{ $task->requirements && in_array('cash-on-delivery', old('requirements', $task->requirements)) ? 'checked' : '' }}>
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <select class="form-select" id="statuses" name="status">
                                        ...
                                        <option value="unassigned"
                                            {{ old('status', $task->status) == null ? 'selected' : '' }}>Unassigned
                                        </option>
                                        <option value="active"
                                            {{ old('status', $task->status) == 'active' ? 'selected' : '' }}>Assigned
                                        </option>
                                        <option value="in-transist"
                                            {{ old('status', $task->status) == 'in-transist' ? 'selected' : '' }}>
                                            In Transit
                                        </option>
                                        <option value="arrived"
                                            {{ old('status', $task->status) == 'arrived' ? 'selected' : '' }}>
                                            Arrived
                                        </option>
                                        ...
                                        <option value="failed"
                                            {{ old('status', $task->status) == 'failed' ? 'selected' : '' }}>Failed
                                        </option>
...
@push('scripts')
            ...
            if (type == "Other") {
                ...
                $.ajax({
                    ...
                    success: function(res, status) {
                        ...
                        $('#service').val("{{ old('service', $task->service_id) }}");
                    },
        ...
        jQuery(document).ready(function($) {
            $('#type').on('change', function(e) {
                ...
                if (val && val != 'Towing') {
                    ...
                    $('input[name="battery_tyre_size"]').val('');
                }
            });
    ...
    <script>
        ...
        var alt_iti = window.intlTelInput(destination_input, {
            initialCountry: "{{ old('destination_iso2', $task->destination_iso2) }}",
            utilsScript: "{{ asset('assets/js/plugins/intl-tel-input/js/utils.js') }}" // just for formatting/placeholders etc
        });
