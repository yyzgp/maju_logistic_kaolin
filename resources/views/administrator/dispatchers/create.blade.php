...
@section('title', 'Create Dispatcher')
@section('head')
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Create Dispatcher</h4>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <form id="superadminForm" method="POST" action="{{ route('administrator.dispatchers.store') }}"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @endif
                                    <img id="preview_img" src="https://placehold.co/150x150/D82D36/FFF?text=Dispatcher"
