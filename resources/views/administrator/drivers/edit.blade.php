...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <form id="driverForm" method="POST" action="{{ route('administrator.drivers.update', $driver->id) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-2 {{ $errors->has('firstname') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" id="firstname" name="firstname"
                                        placeholder="Enter First Name" value="{{ old('firstname', $driver->firstname) }}">
                                    @error('firstname')
                                ...
                                <div class="col-sm-6 mb-2 {{ $errors->has('lastname') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" id="lastname" name="lastname"
                                        placeholder="Enter Last Name" value="{{ old('lastname', $driver->lastname) }}">
                                    @error('lastname')
                                ...
                                <div class="col-sm-6 mb-2 {{ $errors->has('email') ? 'has-error' : '' }}">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email"
                                        placeholder="Enter Email Address" value="{{ old('email', $driver->email) }}">
                                    @error('email')
                                        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-sm-6 mb-2 {{ $errors->has('phone') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" id="phone" name="phone"
                                        placeholder="Enter Phone Number" value="{{ old('phone', $driver->phone) }}">
                                    @error('phone')
                                        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                    <input id="dial-code" name="dialcode" type="hidden"
                                        value="{{ isset($driver) ? $driver->dialcode : '' }}">
                                </div>
                                <div class="col-sm-6 mb-2">
                                    ...
                                    <select id="gender" class="form-select" name="gender">
                                        ...
                                        <option value="Male"
                                            {{ old('gender', $driver->gender) == 'Male' ? 'selected' : '' }}>Male</option>
                                        <option value="Female"
                                            {{ old('gender', $driver->gender) == 'Female' ? 'selected' : '' }}>Female
                                        </option>
                                    </select>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @endif
                                    <img id="preview_img" src="{{ $driver->avatar }}" class="mt-2" width="100"
                                        height="100" />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-2">
                                    ...
                                    <select id="vehicle_type" class="form-select" name="vehicle_type">
                                        ...
                                        <option value="Car"
                                            {{ old('vehicle_type', $driver->vehicle_type) == 'Car' ? 'selected' : '' }}>🚘
                                            Car</option>
                                        <option value="Van"
                                            {{ old('vehicle_type', $driver->vehicle_type) == 'Van' ? 'selected' : '' }}>🚚
                                            Van</option>
                                        <option value="Truck"
                                            {{ old('vehicle_type', $driver->vehicle_type) == 'Truck' ? 'selected' : '' }}>
                                            🚍 Truck</option>
                                        <option value="Bike"
                                            {{ old('vehicle_type', $driver->vehicle_type) == 'Bike' ? 'selected' : '' }}>
                                            🏍️ Bike</option>
                                        <option value="Bicycle"
                                            {{ old('vehicle_type', $driver->vehicle_type) == 'Bicycle' ? 'selected' : '' }}>
                                            🚴 Bicycle</option>
                                        <option value="Walking"
                                            {{ old('vehicle_type', $driver->vehicle_type) == 'Walking' ? 'selected' : '' }}>
                                            🚶🏻 Walking</option>
                                    </select>
                                ...
                                <div class="col-sm-6 mb-2 {{ $errors->has('vehicle_description') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" id="vehicle_description"
                                        ...
                                        value="{{ old('vehicle_description', $driver->vehicle_description) }}">
                                ...
                                <div
                                    ...
                                    <input type="text" class="form-control" id="vehicle_registration_no"
                                        ...
                                        value="{{ old('vehicle_registration_no', $driver->vehicle_registration_no) }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-2 {{ $errors->has('address') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" id="address" name="address"
                                        placeholder="Enter Address" value="{{ old('address', $driver->address) }}">
                                    @error('address')
                                        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-sm-6 mb-2 {{ $errors->has('city') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" id="city" name="city"
                                        placeholder="Enter City" value="{{ old('city', $driver->city) }}">
                                    @error('city')
                                        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-sm-6 mb-2 {{ $errors->has('state') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" id="state" name="state"
                                        placeholder="Enter State" value="{{ old('state', $driver->state) }}">
                                    @error('state')
                                        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-sm-6 mb-2 {{ $errors->has('zipcode') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" id="zipcode" name="zipcode"
                                        placeholder="Enter Zipcode" value="{{ old('zipcode', $driver->zipcode) }}">
                                    @error('zipcode')
                                        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
...
@push('scripts')
    ...
    <script>
        ...
        var iti = window.intlTelInput(input, {
            initialCountry: "{{ old('iso2', $driver->iso2) }}",
