...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <form id="superadminForm" method="POST" action="{{ route('administrator.services.store') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-2 {{ $errors->has('type') ? 'has-error' : '' }}">
                                    ...
                                    <select name="type[]" id="type" class="form-select form-control-sm select2"
                                        ...
                                        <option></option>
                                        <option value="Towing" {{ in_array('Towing', old('type', [])) ? 'selected' : '' }}>
                                            Towing
                                        </option>
                                        <option value="Battery/Tyre"
                                            {{ in_array('Battery/Tyre', old('type', [])) ? 'selected' : '' }}>Battery/Tyre
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-12 mb-2 {{ $errors->has('merchants') ? 'has-error' : '' }}">
                                    ...
                                    @if (count($merchants) > 0)
                                        <div class="row ms-0 me-0 my-2"
                                            style="background-color: #ff00001a; font-size:14px;">
                                                ...
                                                <div class="col-md-3 mt-2">
                                                    <div class="form-check form-checkbox-danger mb-2">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="{{ $merchant->id }}"
                                                            {{ in_array($merchant->id, old('merchants', [])) ? 'checked' : '' }}>
                                ...
                                <div class="col-sm-6 mb-2 {{ $errors->has('price') ? 'has-error' : '' }}">
                                    ...
                                    <input type="number" class="form-control" id="price" name="price"
                                        placeholder="Enter Base Price" step="any" value="{{ old('price', 0.0) }}">
                                    @error('price')
                                        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-sm-6 mb-2 {{ $errors->has('extra_night_price') ? 'has-error' : '' }}">
                                    ...
                                    <input type="number" class="form-control" id="extra_night_price"
                                        ...
                                        value="{{ old('extra_night_price', 0.0) }}">
